...
const DIFFICULTY_CONFIG = [
  {
    level: "beginner",
    label: "Beginner",
    desc: "Key signatures, basic intervals, major & minor scales, simple triads.",
  ...
  },
  {
    level: "intermediate",
    label: "Intermediate",
    desc: "Modes, seventh chords, secondary dominants, compound meters, voice leading basics.",
  ...
  },
  {
    level: "advanced",
    label: "Advanced",
    desc: "Melodic minor modes, altered dominants, polytonal harmony, Messiaen modes, Schenkerian analysis.",
